...
namespace GetOutside.Adapters
{
    public class outsideActivityDailyAdapter : RecyclerView.Adapter
    {
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            {
                outsideActivityViewHolder.OutsideActivityDailyTextView.Text = _outsideActivities[position].StartTime.ToString("yyyy-MM-dd") + "  " + (TimeSpan.FromMilliseconds(_outsideActivities[position].DurationMilliseconds)).ToString();
            }
        }
